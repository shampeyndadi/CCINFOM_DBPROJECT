...
public class AdminController {
    ...
    public AdminController(AdminView adminView, AdminLogin adminLogin){
                ...
                adminView.setListOfColleges(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (selectedCollege != null && !selectedCollege.isEmpty()) {
                            adminView.resetProgramsAndCourses();
        ...
        this.adminView.setUpdateTerm(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int response = JOptionPane.showConfirmDialog(
                        null,
                        "Are you sure you want to update the term? This action cannot be undone.",
                        "Confirm Update",
                ...
                if (response == JOptionPane.YES_OPTION) {
                    AdminDao adminDao = new AdminDao();
                    adminDao.updateTermAndSchoolYear();
                } else {
    ...
    private void registerStudent(AdminView adminView, AdminDao adminDao, StudentDao studentDao){
        try{
            ...
            if (studentDao.isDuplicateStudent(firstName, lastName, email, birthday)) {
                JOptionPane.showMessageDialog(adminView, "A student with the same details already exists in the system.", "Duplicate Record", JOptionPane.WARNING_MESSAGE);
                return;
            }
    ...
    private void registerInstructor(AdminView adminView, AdminDao adminDao, InstructorDao instructorDao) {
        try {
            ...
            String generatedPassWord = adminDao.generatePassword();
            Instructor instructor = new Instructor(instructorId, instructorFirstName, instructorLastName, collegeId, instructorContactNo, instructorEmail, generatedPassWord);
