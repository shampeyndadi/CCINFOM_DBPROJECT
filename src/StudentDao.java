...
public class StudentDao{
    ...
    public void enrollStudent(int studentId, int classId, String courseId) {
        ...
        // Check if the course belongs to the student's program
    ...
    """;
        ...
        try (Connection conn = DatabaseConnect.getConnection();
            ...
            JOptionPane.showMessageDialog(null, "Error checking dropped courses: " + e.getMessage(), "Database Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
