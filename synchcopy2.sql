...
VALUES
    ...
    ('ENGMECH', 'Engineering Mechanics', 5, 6, NULL),
    ('THERMOD', 'Thermodynamics', 5, 6, NULL),
    ('MATEENG', 'Materials Engineering', 5, 6, NULL),
    ('ELECENG', 'Electrical Engineering Fundamentals', 5, 6, NULL),
    ('CIVDES', 'Civil Design Principles', 5, 6, NULL),
    ('COMPSCI', 'Introduction to Computer Science', 5, 6, NULL),
    ('FLUIDMECH', 'Fluid Mechanics', 5, 6, NULL),
    ('STRUCTAN', 'Structural Analysis', 5, 6, NULL),
    ('PROGMETH', 'Programming Methods', 5, 6, NULL),
    ('DIGISYS', 'Digital Systems Design', 5, 6, NULL),
    ('CONTROL', 'Control Systems Engineering', 5, 6, NULL),
    ...
    ('CHEMENG', 'Chemical Engineering Fundamentals', 5, 6, 'GCOE-CHE'),
    ('CHEMTHERM', 'Chemical Thermodynamics', 3, 6, 'GCOE-CHE'),
    ('REACTION', 'Chemical Reaction Engineering', 5, 6, 'GCOE-CHEL'),
    ('HEATTRANS', 'Heat Transfer Operations', 3, 6, 'GCOE-CHE'),
    ('MASSFLOW', 'Mass Transfer Processes', 5, 6, 'GCOE-CHE'),
    ('PROCESS', 'Process Design and Analysis', 3, 6, 'GCOE-CHE'),
    ...
    ('STRUCTAN', 'Structural Analysis and Design', 3, 6, 'GCOE-CE'),
    ('SURVEY', 'Surveying and Geomatics', 5, 6, 'GCOE-CE'),
    ('GEOTECH', 'Geotechnical Engineering', 5, 6, 'GCOE-CE'),
    ('HYDROENG', 'Hydraulics and Hydrology', 3, 6, 'GCOE-CE'),
    ('CONMATS', 'Construction Materials', 5, 6, 'GCOE-CE'),
    ...
    ('EMAG', 'Electromagnetic Theory', 3, 6, 'GCOE-ECE'),
    ('MICROPRO', 'Microprocessor Systems', 5, 6, 'GCOE-ECE'),
    ('VLSI', 'VLSI Design Principles', 4, 6, 'GCOE-ECE'),
    ('EMBEDDED', 'Embedded Systems', 3, 6, 'GCOE-ECE'),
    ('NETWORK', 'Computer Networks', 5, 6, 'GCOE-ECE'),
    ...
    ('INDUSTDES', 'Industrial Design Principles', 3, 6, 'GCOE-IE'),
    ('OPERRES', 'Operations Research', 5, 6, 'GCOE-IE'),
    ('QUALITY', 'Quality Control and Assurance', 4, 6, 'GCOE-IE'),
    ('SUPPLY', 'Supply Chain Management', 3, 6, 'GCOE-IE'),
    ('SYSENG', 'Systems Engineering', 5, 6, 'GCOE-IE'),
    ...
    ('AUTOMATION', 'Automation and Robotics', 3, 6, 'GCOE-MEM'),
    ('MATERMAN', 'Materials Management', 5, 6, 'GCOE-MEM'),
    ('CADD', 'Computer-Aided Design and Drafting', 4, 6, 'GCOE-MEM'),
    ('LEANMANUF', 'Lean Manufacturing Principles', 3, 6, 'GCOE-MEM'),
    ('PRODPLAN', 'Production Planning and Control', 5, 6, 'GCOE-MEM'),
    ...
    ('DYNAMICS', 'Dynamics of Machines', 3, 6, 'GCOE-ME'),
    ('FLUIDMECH', 'Fluid Mechanics', 4, 6, 'GCOE-ME'),
    ('MACHDES', 'Machine Design', 5, 6, 'GCOE-ME'),
    ('HEATTRANS', 'Heat Transfer', 3, 6, 'GCOE-ME'),
    ('ENGMAT', 'Engineering Materials', 4, 6, 'GCOE-ME'),
    ...
    ('EDFOUND', 'Foundations of Education', 4, 1, NULL),
    ('CHILDPDEV', 'Child Development', 3, 1, NULL),
    ('EDTECH', 'Educational Technology', 5, 1, NULL),
    ('CLASSMAN', 'Classroom Management', 4, 1, NULL),
    ('CURRDEV', 'Curriculum Development', 3, 1, NULL),
    ('ASSESSED', 'Assessment in Education', 5, 1, NULL),
    ...
    ('CAREERDEV', 'Career Development and Counseling', 3, 1, 'BAGCED-CEP'),
    ('GROUPTHER', 'Group Therapy and Counseling', 5, 1, 'BAGCED-CEP'),
    ('DEVPSYCH', 'Developmental Psychology', 4, 1, 'BAGCED-CEP'),
    ('ETHICCOUN', 'Ethics in Counseling', 3, 1, 'BAGCED-CEP'),
    ('PSYCHASS', 'Psychological Assessment', 5, 1, 'BAGCED-CEP'),
    ...
    ('LEADDEVEL', 'Leadership Development in Education', 3, 1, 'BAGCED-ELM'),
    ('MGTINNOV', 'Management and Innovation in Education', 5, 1, 'BAGCED-ELM'),
    ('CURRLEAD', 'Curriculum Leadership and Design', 4, 1, 'BAGCED-ELM'),
    ('SCHOOLDEV', 'School Development and Improvement', 3, 1, 'BAGCED-ELM'),
    ('LEADERSHIP', 'Advanced Leadership in Education', 5, 1, 'BAGCED-ELM'),
    ...
    ('PHONETICS', 'Phonetics and Phonology', 3, 1, 'BAGCED-EAL'),
    ('SYNTHESIS', 'Syntax and Grammar', 5, 1, 'BAGCED-EAL'),
    ('MORPHOLOGY', 'Morphology and Word Formation', 4, 1, 'BAGCED-EAL'),
    ('SOCIOLING', 'Sociolinguistics', 3, 1, 'BAGCED-EAL'),
    ('LANGACQUIS', 'Language Acquisition', 5, 1, 'BAGCED-EAL'),
    ...
    ('SPORTSACT', 'Sports and Activities', 3, 1, 'BAGCED-PE'),
    ('ATHLETRAIN', 'Athletic Training and Injury Prevention', 5, 1, 'BAGCED-PE'),
    ('EXERCISESCI', 'Exercise Science and Physiology', 4, 1, 'BAGCED-PE'),
    ('HEALTHED', 'Health Education and Promotion', 3, 1, 'BAGCED-PE'),
    ('SPORTMGT', 'Sports Management and Administration', 5, 1, 'BAGCED-PE'),
    ...
    ('BIOEDU', 'Biology Education', 3, 1, 'BAGCED-SE'),
    ('CHEMEDU', 'Chemistry Education', 5, 1, 'BAGCED-SE'),
    ('PHYSED', 'Physics Education', 4, 1, 'BAGCED-SE'),
    ('EARTHSCI', 'Earth Science Education', 3, 1, 'BAGCED-SE'),
    ('SCIRES', 'Science Research and Inquiry', 5, 1, 'BAGCED-SE'),
    ...
    ('EXTENG', 'Extension Engineering Practices', 3, 1, 'BAGCED-OEP'),
    ('MARITIME', 'Maritime Safety and Operations', 5, 1, 'BAGCED-OEP'),
    ('OFFSHORELAW', 'Offshore Regulations and Law', 4, 1, 'BAGCED-OEP'),
    ('SUBSEA', 'Subsea Engineering and Technology', 3, 1, 'BAGCED-OEP'),
    ('RISKMGMT', 'Risk Management in Offshore Operations', 5, 1, 'BAGCED-OEP'),
    ...
    ('TECHINNO', 'Technological Innovations in Education', 3, 1, 'BAGCED-CIESOL'),
    ('EDUREFORM', 'Educational Reform and Practices', 5, 1, 'BAGCED-CIESOL'),
    ('MOBILELEARN', 'Mobile Learning Technologies', 4, 1, 'BAGCED-CIESOL'),
    ('E-LEARN', 'E-Learning Systems and Design', 3, 1, 'BAGCED-CIESOL'),
    ('DIGITALPED', 'Digital Pedagogy', 5, 1, 'BAGCED-CIESOL'),
    ...
    ('MACROECON', 'Macroeconomics Principles', 3, 8, NULL),
    ('STATECON', 'Statistics for Economics', 5, 8, NULL),
    ('ECONMATH', 'Mathematics for Economics', 4, 8, NULL),
    ('ECONMODELS', 'Economic Modeling and Forecasting', 3, 8, NULL),
    ('FINANCE', 'Introduction to Finance', 5, 8, NULL),
    ...
    ('ECOOFIND', 'Economics of Industrial Development', 3, 8, 'SOE-BS-AEI'),
    ('COMPETITION', 'Competition and Antitrust Economics', 5, 8, 'SOE-BS-AEI'),
    ('LABOURMKT', 'Labour Market Economics in Industry', 4, 8, 'SOE-BS-AEI'),
    ('INDUSTREG', 'Industrial Regulation and Policy', 3, 8, 'SOE-BS-AEI'),
    ('INDECONMGT', 'Industrial Economics and Management', 5, 8, 'SOE-BS-AEI'),
    ...
    ('CORPFIN', 'Corporate Finance and Investment', 3, 8, 'SOE-BS-AEF'),
    ('RISKMGMT', 'Risk Management in Finance', 5, 8, 'SOE-BS-AEF'),
    ('INVESTMENT', 'Investment Analysis and Portfolio Management', 4, 8, 'SOE-BS-AEF'),
    ('FINANALYTICS', 'Financial Analytics and Modeling', 3, 8, 'SOE-BS-AEF'),
    ('MACROFIN', 'Macroeconomic Foundations of Finance', 5, 8, 'SOE-BS-AEF'),
    ...
    ('MICROECON', 'Microeconomic Theory', 3, 8, 'SOE-AB-ECM'),
    ('MACROECON', 'Macroeconomics Principles', 5, 8, 'SOE-AB-ECM'),
    ('PUBLICECON', 'Public Economics and Policy', 4, 8, 'SOE-AB-ECM'),
    ('MATHFORECON', 'Mathematics for Economics', 3, 8, 'SOE-AB-ECM'),
    ('ECONDEV', 'Economic Development and Globalization', 5, 8, 'SOE-AB-ECM'),
    ...
    ('PHIL', 'Philosophy of Ethics', 3, 4, NULL),
    ('SOC', 'Sociology and Society', 5, 4, NULL),
    ('PSYCH', 'Psychology and Human Behavior', 4, 4, NULL),
    ('ART', 'Art History and Criticism', 3, 4, NULL),
    ('MUSIC', 'Music Appreciation', 5, 4, NULL),
    ...
    ('SOCDEVELOP', 'Social Systems Development', 3, 8, 'CLA-BSHS-OSSD'),
    ('LEADERSHIP', 'Leadership in Organizational Settings', 5, 4, 'CLA-BSHS-OSSD'),
    ('CULTUREANDORG', 'Organizational Culture and Behavior', 4, 4, 'CLA-BSHS-OSSD'),
    ('COMMUNICATION', 'Organizational Communication', 3, 8, 'CLA-BSHS-OSSD'),
    ('CHANGELEADERSHIP', 'Change Leadership in Organizations', 5, 4, 'CLA-BSHS-OSSD'),
    ...
    ('SOCDEVEL', 'Social Development and Policy', 3, 4, 'CLA-DS'),
    ('GENDERDEV', 'Gender and Development', 5, 4, 'CLA-DS'),
    ('ENVIRONDEV', 'Environmental Sustainability and Development', 4, 4, 'CLA-DS'),
    ('HUMANDEV', 'Human Development and Well-being', 3, 4, 'CLA-DS'),
    ('RURALDEV', 'Rural Development and Community Building', 5, 4, 'CLA-DS'),
    ...
    ('SEACULTURE', 'Southeast Asian Culture and Traditions', 3, 4, 'CLA-SEA'),
    ('POLSEAN', 'Politics of Southeast Asia', 5, 4, 'CLA-SEA'),
    ('ECONSEAN', 'Economic Development in Southeast Asia', 4, 4, 'CLA-SEA'),
    ('SEASOCIETY', 'Social Issues in Southeast Asia', 3, 4, 'CLA-SEA'),
    ('SEARELIGION', 'Religion and Beliefs in Southeast Asia', 5, 4, 'CLA-SEA'),
    ...
    ('AMPOLITICS', 'American Political Institutions and Processes', 3, 4, 'CLA-IS-AMS'),
    ('AMERICANLIT', 'American Literature and Culture', 5, 4, 'CLA-IS-AMS'),
    ('USFOREIGNPOLICY', 'U.S. Foreign Policy and Global Relations', 4, 4, 'CLA-IS-AMS'),
    ('AMERICONOMY', 'The American Economy and Globalization', 3, 4, 'CLA-IS-AMS'),
    ('USCIVILRIGHTS', 'Civil Rights and Social Movements in the U.S.', 5, 4, 'CLA-IS-AMS'),
    ...
    ('EUPOLITICS', 'European Political Systems and Governance', 3, 4, 'CLA-IS-EUS'),
    ('EUROPEANLIT', 'European Literature and Culture', 5, 4, 'CLA-IS-EUS'),
    ('EUROPEANECONOMY', 'The European Economy and Integration', 4, 4, 'CLA-IS-EUS'),
    ('EUROPEANSOCIETY', 'Social Structures and Issues in Europe', 3, 4, 'CLA-IS-EUS'),
    ('EUROPEANDIPLOMACY', 'European Diplomacy and Foreign Relations', 5, 4, 'CLA-IS-EUS'),
    ...
    ('JPOLITICS', 'Politics of Japan', 3, 4, 'CLA-IS-JPS'),
    ('JAPANLIT', 'Japanese Literature and Culture', 5, 4, 'CLA-IS-JPS'),
    ('JAPANESEECONOMY', 'Japanese Economy and Globalization', 4, 4, 'CLA-IS-JPS'),
    ('JAPANSOCIETY', 'Society and Social Issues in Japan', 3, 4, 'CLA-IS-JPS'),
    ('JAPANDIPLOMACY', 'Japanese Diplomacy and Foreign Relations', 5, 4, 'CLA-IS-JPS'),
    ...
    ('CHINAPOLITICS', 'Politics of China', 3, 4, 'CLA-IS-CNS'),
    ('CHINESELIT', 'Chinese Literature and Culture', 5, 4, 'CLA-IS-CNS'),
    ('CHINESEECONOMY', 'Chinese Economy and Development', 4, 4, 'CLA-IS-CNS'),
    ('CHINASOCIETY', 'Social Issues and Structures in China', 3, 4, 'CLA-IS-CNS'),
    ('CHINADIPLOMACY', 'Chinese Diplomacy and Foreign Relations', 5, 4, 'CLA-IS-CNS'),
    ...
    ('FICTION', 'Fiction Writing Techniques', 3, 4, 'CLA-LIT-CW'),
    ('POETRY', 'Poetry Writing and Analysis', 5, 4, 'CLA-LIT-CW'),
    ('DRAMA', 'Playwriting and Dramatic Structure', 4, 4, 'CLA-LIT-CW'),
    ('CREATIVESTYLE', 'Developing Your Creative Style', 3, 4, 'CLA-LIT-CW'),
    ('LITCRITICISM', 'Literary Criticism and Theory for Writers', 5, 4, 'CLA-LIT-CW'),
    ...
    ('CULTSTUDIES', 'Introduction to Cultural Studies', 3, 4, 'CLA-LIT-LC'),
    ('POSTCOLONIAL', 'Postcolonial Literature and Theory', 5, 4, 'CLA-LIT-LC'),
    ('FEMINISTLIT', 'Feminist Literary Theory', 4, 4, 'CLA-LIT-LC'),
    ('WORLDLIT', 'World Literature and Global Perspectives', 3, 4, 'CLA-LIT-LC'),
    ('AMERICANCULTURE', 'American Culture and Society', 5, 4, 'CLA-LIT-LC'),
    ...
    ('FILIPINONEWS', 'Filipino Journalism and News Writing', 3, 4, 'CLA-PHS'),
    ('FILMMAKING', 'Filmmaking in the Filipino Context', 5, 4, 'CLA-PHS'),
    ('RADIOFILIPINO', 'Filipino Radio and Broadcasting', 4, 4, 'CLA-PHS'),
    ('FILIPINOTV', 'Television and Filipino Audiences', 3, 4, 'CLA-PHS'),
    ('DIGITALMEDIA', 'Filipino Digital Media and Technology', 5, 4, 'CLA-PHS'),
    ...
    ('GOVERNANCE', 'Principles of Governance and Public Administration', 3, 4, 'CLA-PLS'),
    ('INTERNATIONALRELATIONS', 'International Relations and Diplomacy', 5, 4, 'CLA-PLS'),
    ('PUBLICPOLICY', 'Public Policy and Decision-Making', 4, 4, 'CLA-PLS'),
    ('CONSTITUTIONALLAW', 'Constitutional Law and Legal Systems', 3, 4, 'CLA-PLS'),
    ('POLITICALPARTIES', 'Political Parties and Electoral Systems', 5, 4, 'CLA-PLS'),
    ...
    ('MEDIAETHICS', 'Media Ethics and Social Responsibility', 3, 4, 'CLA-CA'),
    ('JOURNALISMWRITING', 'Journalism Writing and Reporting', 5, 4, 'CLA-CA'),
    ('PUBLICRELATIONS', 'Public Relations and Media Campaigns', 4, 4, 'CLA-CA'),
    ('ADVERTISING', 'Advertising and Marketing Communication', 3, 4, 'CLA-CA'),
    ('RADIOBROADCAST', 'Radio Broadcasting and Production', 5, 4, 'CLA-CA'),
    ...
    ('COMMUNICATIVESTRATEGY', 'Strategic Communication in Organizations', 3, 4, 'CLA-OC'),
    ('CONFLICTRESOLUTION', 'Conflict Resolution and Negotiation Skills', 5, 4, 'CLA-OC'),
    ('INTERNALCOMMUNICATION', 'Internal Communication in Organizations', 4, 4, 'CLA-OC'),
    ('CROSSCULTURALCOMM', 'Cross-Cultural Communication in the Workplace', 3, 4, 'CLA-OC'),
    ('COMMUNICATIONETHICS', 'Ethics in Organizational Communication', 5, 4, 'CLA-OC'),
    ...
    ('ETHICS', 'Ethics and Moral Philosophy', 3, 4, 'CLA-PHL'),
    ('LOGIC', 'Logic and Critical Thinking', 5, 4, 'CLA-PHL'),
    ('METAPHYSICS', 'Metaphysics and the Nature of Reality', 4, 4, 'CLA-PHL'),
    ('EPISTEMOLOGY', 'Epistemology: Theory of Knowledge', 3, 4, 'CLA-PHL'),
    ('PHILHISTORY', 'History of Philosophy: Ancient to Modern', 5, 4, 'CLA-PHL'),
    ...
    ('DEVELOPMENTALPSY', 'Developmental Psychology', 3, 4, 'CLA-PSY'),
    ('SOCIALPSYCHOLOGY', 'Social Psychology', 5, 4, 'CLA-PSY'),
    ('CLINICALPSYCHOLOGY', 'Clinical Psychology and Counseling', 4, 4, 'CLA-PSY'),
    ('COGNITIVEPSYCH', 'Cognitive Psychology and Perception', 3, 4, 'CLA-PSY'),
    ('RESEARCHMETHODS', 'Research Methods in Psychology', 5, 4, 'CLA-PSY'),
    ...
    ('PSYCHSTATISTICS', 'Statistics for Psychology', 3, 4, 'CLA-BSPSY'),
    ('PSYCHASSESSMENT', 'Psychological Assessment and Testing', 5, 4, 'CLA-BSPSY'),
    ('COGNITIVESCIENCE', 'Cognitive Science and Behavioral Neuroscience', 4, 4, 'CLA-BSPSY'),
    ('PSYCHOPHARMACOLOGY', 'Psychopharmacology and Substance Use', 3, 4, 'CLA-BSPSY'),
    ('RESEARCHPSYCH', 'Research Methods in Psychology', 5, 4, 'CLA-BSPSY'),
    ...
    ('SOCIOLOGICALTHEORY', 'Classical Sociological Theory', 3, 4, 'CLA-SOC'),
    ('SOCIALSTRATIFICATION', 'Social Stratification and Inequality', 5, 4, 'CLA-SOC'),
    ('CULTURALSOCIOLOGY', 'Cultural Sociology and Society', 4, 4, 'CLA-SOC'),
    ('URBANSOCIETY', 'Urban Sociology and Communities', 3, 4, 'CLA-SOC'),
    ('DEVIANCEANDCRIME', 'Deviance and Criminology', 5, 4, 'CLA-SOC'),
    ...
    ('LEADERSHIPTHEORY', 'Leadership Theory and Practice in Organizations', 3, 4, 'CLA-MA-BSHS-OSSD'),
    ('SOCIALSYSTEMS', 'Social Systems Theory and Applications', 5, 4, 'CLA-MA-BSHS-OSSD'),
    ('CULTURALCOMPETENCE', 'Cultural Competence in Organizational Systems', 4, 4, 'CLA-MA-BSHS-OSSD'),
    ('CONFLICTMANAGEMENT', 'Conflict Management and Resolution', 3, 4, 'CLA-MA-BSHS-OSSD'),
    ('CHANGEAGENTROLES', 'Change Agents in Organizational Systems', 5, 4, 'CLA-MA-BSHS-OSSD'),
    ...
    ('CIVILLAW', 'Civil Law and Legal Procedures', 5, 3, NULL),
    ('CONSTITUTIONALLAW', 'Constitutional Law and Governance', 4, 3, NULL),
    ('LEGALRESEARCH', 'Legal Research and Writing', 5, 3, NULL),
    ('LAWOFOBLIGATIONS', 'Law of Obligations and Contracts', 3, 3, NULL),
    ('CRIMINALLAW', 'Criminal Law and Procedure', 5, 3, 'AB-LSSD'),
    ('BUSINESSLAW', 'Business Law and Corporate Governance', 4, 3, 'AB-LSSD'),
    ('FAMILYLAW', 'Family Law and Domestic Relations', 3, 3, 'AB-LSSD'),
    ('ENVIRONMENTALLAW', 'Environmental Law and Policies', 5, 3, 'AB-LSSD'),
    ('INTLRELATIONSLAW', 'International Relations and Law', 4, 3, 'AB-LSSD');
